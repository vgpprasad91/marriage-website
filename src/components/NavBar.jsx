...
const sections = [
  ...
  { id: 'live_stream', title: 'LiveStreaming' },
]
...
export function NavBar() {
  ...
  useEffect(() => {
    function updateActiveIndex() {
      ...
      for (let index = 0; index < elements.length; index++) {
        if (elements[index] && window.scrollY >= elements[index].getBoundingClientRect().top - offset) {
  ...
  return (
    <div ref={navBarRef} className="mt-5 sticky top-0 z-50 bg-light_green">
